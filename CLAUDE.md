...
**OpenAI**: Uses GPT-5-mini (and GPT-5-nano for quick checks) for content generation, prompt evaluation, and improvements. All calls tracked for usage monitoring.
